...
for i = 1:length(files) %iterate through experiment folder
    ...
    Rew_Trial_Saline = [Rew_Trial_Saline; sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 1 & sesdat.traces_z(:, 4) == 1, 5:323)];
    Rew_Trial_Saline_O = [Rew_Trial_Saline_O; sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 1 & sesdat.traces_z(:, 4) == 0, 5:323)];
    Pun_Trial_Saline = [Pun_Trial_Saline; sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 2 & sesdat.traces_z(:, 4) == 1, 5:323)];
    Pun_Trial_Saline_Omit = [Pun_Trial_Saline_Omit; sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 2 & sesdat.traces_z(:, 4) == 0, 5:323)];
    Conf_Saline_F = [Conf_Saline_F;sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 2, 5:323)];
    Conf_Saline_S = [Conf_Saline_S;sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 3, 5:323)];
    Conf_Sal_Trial = [Conf_Sal_Trial ;sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3, 5:323)];
    Conf_Sal_Trial_O = [Conf_Sal_Trial_O;sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 0, 5:323)];

    % Repeat for Alc_test condition (similar to Saline)
    Rew_Trial_Alc = [Rew_Trial_Alc;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 1 & sesdat.traces_z(:, 4) == 1, 5:323)];
    Rew_Trial_Alc_O = [Rew_Trial_Alc_O; sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 1 & sesdat.traces_z(:, 4) == 0, 5:323)];
    Pun_Trial_Alc = [Pun_Trial_Alc ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 2 & sesdat.traces_z(:, 4) == 1, 5:323)];
    Pun_Trial_Alc_Omit = [Pun_Trial_Alc_Omit ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 2 & sesdat.traces_z(:, 4) == 0, 5:323)];
    Conf_Alc_F = [Conf_Alc_F ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 2, 5:323)];
    Conf_Alc_S = [Conf_Alc_S ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 3, 5:323)];
    Conf_Alc_Trial = [Conf_Alc_Trial ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3, 5:323)];
    Conf_Alc_Trial_O = [Conf_Alc_Trial_O ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 0, 5:323)];
...
%___________ Dimensions and labels used for the plots ______________
    ...
    time = linspace(-10, 10, size(Rew_Trial_Saline, 2));
