...
for i = 1:length(files) %iterate through experiment folder
    ...
    Rew_Trial_Saline = [Rew_Trial_Saline; sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 1 & sesdat.traces_z(:, 4) == 1, 5:end)];
    Rew_Trial_Saline_O = [Rew_Trial_Saline_O; sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 1 & sesdat.traces_z(:, 4) == 0, 5:end)];
    Pun_Trial_Saline = [Pun_Trial_Saline; sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 2 & sesdat.traces_z(:, 4) == 1, 5:end)];
    Pun_Trial_Saline_Omit = [Pun_Trial_Saline_Omit; sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 2 & sesdat.traces_z(:, 4) == 0, 5:end)];
    Conf_Saline_F = [Conf_Saline_F;sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 2, 5:end)];
    Conf_Saline_S = [Conf_Saline_S;sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 3, 5:end)];
    Conf_Sal_Trial = [Conf_Sal_Trial ;sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3, 5:end)];
    Conf_Sal_Trial_O = [Conf_Sal_Trial_O;sesdat.traces_z(is_saline_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 0, 5:end)];

    % Repeat for Alc_test condition (similar to Saline)
    Rew_Trial_Alc = [Rew_Trial_Alc;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 1 & sesdat.traces_z(:, 4) == 1, 5:end)];
    Rew_Trial_Alc_O = [Rew_Trial_Alc_O; sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 1 & sesdat.traces_z(:, 4) == 0, 5:end)];
    Pun_Trial_Alc = [Pun_Trial_Alc ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 2 & sesdat.traces_z(:, 4) == 1, 5:end)];
    Pun_Trial_Alc_Omit = [Pun_Trial_Alc_Omit ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 2 & sesdat.traces_z(:, 4) == 0, 5:end)];
    Conf_Alc_F = [Conf_Alc_F ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 2, 5:end)];
    Conf_Alc_S = [Conf_Alc_S ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 3, 5:end)];
    Conf_Alc_Trial = [Conf_Alc_Trial ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3, 5:end)];
    Conf_Alc_Trial_O = [Conf_Alc_Trial_O ;sesdat.traces_z(is_alc_test_and_rat & is_valid_row & sesdat.traces_z(:, 2) == 3 & sesdat.traces_z(:, 4) == 0, 5:end)];
